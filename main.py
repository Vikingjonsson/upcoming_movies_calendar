...
def scrape_movie_detail_page(
    ...
    try:
        ...
        # ⚡ Bolt: Bulk fetch movie details via JavaScript to eliminate massive IPC overhead
        # from multiple synchronous find_element, .text and get_attribute calls.
        ...
        poster_image_url = details.get("poster")
