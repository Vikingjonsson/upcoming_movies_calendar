...
def collect_movie_links_from_calendar_page(
    ...
    # ⚡ Bolt: Bulk DOM extraction using execute_script instead of multiple synchronous Selenium IPC calls
    # This significantly reduces roundtrip overhead for find_element, .text, and .get_attribute
    script = """
