...
def collect_movie_links_from_calendar_page(
    ...
    # ⚡ Bolt: Use execute_script to fetch all movie data in bulk via JavaScript.
    # This avoids multiple synchronous find_element/find_elements/get_attribute calls
    # per movie, which significantly reduces IPC overhead and speeds up extraction.
    script = """
    ...
    for (const section of sections) {
        ...
        for (const entry of entries) {
            ...
            // Note: use element.href instead of getAttribute('href') to get absolute URL
