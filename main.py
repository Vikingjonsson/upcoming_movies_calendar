...
def collect_movie_links_from_calendar_page(
    ...
    # ⚡ Bolt: Use execute_script to fetch all movie data in a single IPC roundtrip instead of O(N) element lookups
    js_script = """
    ...
    scraped_movies_data = driver.execute_script(
        js_script,
    ...
    movie_links: list[ScheduledMovie] = [
        ...
        for data in scraped_movies_data
    ]
