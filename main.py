...
def collect_movie_links_from_calendar_page(
    ...
    # ⚡ Bolt: Use JavaScript for bulk DOM extraction to avoid slow Selenium IPC calls
    script = f"""
    ...
    for (const section of sections) {{
        ...
        for (const entry of entries) {{
            ...
            const href = titleEl.href; // ⚡ Bolt: .href automatically resolves to absolute URL
            const title = titleEl.innerText.trim(); // ⚡ Bolt: .innerText matches Selenium's .text behavior
